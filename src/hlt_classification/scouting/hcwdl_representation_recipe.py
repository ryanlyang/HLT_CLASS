...
``HCWDL_RECIPE/v4`` teacher recipe.  Version 5 freezes the dense four-track descent
and explicitly binds RREL to raw, normalized block-two relation geometry without
a trainable relation projection.  It does not import the obsolete base-HCWDL
ladder or finalist chain:
...
def _scientific_values() -> dict[str, Any]:
    ...
    return {
        ...
        "relations": {
            ...
            "latent_state_source": "raw_particle_block_2",
            "latent_projection_applied": False,
            "latent_normalization": "fp32_l2_eps_1e-12",
            "latent_statistic": (
                "cosine_similarity_of_raw_fp32_l2_normalized_"
                "particle_block_2_states"
            ),
            "kernel": {
                "kind": "fixed_multiscale_spectral_moment",
