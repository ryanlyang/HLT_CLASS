...
_DENSE_RESOURCE_COMPATIBILITY_CHANGED_PATHS: Final = frozenset({
    ...
    "scripts/prepare_hcwdl_representation_dense_smoke_candidate.py",
    ...
    "src/hlt_classification/scouting/hcwdl_representation_candidate.py",
    "src/hlt_classification/scouting/hcwdl_representation_dense_preparation.py",
