...
ROUTES: Final = {
    ...
    _c("TIGRIS_EVIDENCE_BUNDLE"): ArtifactRoute("acceptance/tigris_evidence_bundle.json", "tigris_acceptance", "validate_tigris_evidence_bundle"),
    ...
    _c("USR1_EXACT_RESUME_PROOF"): ArtifactRoute("acceptance/proofs/usr1_exact_resume_result.json", "acceptance_evidence", "validate_usr1_exact_resume_proof"),
    _c("VALIDATION_PROXY_PROOF"): ArtifactRoute("acceptance/proofs/final_role_validation_proxy_result.json", "acceptance_evidence", "validate_validation_proxy_proof"),
    ...
    _c("TIGRIS_ACCEPTANCE"): ArtifactRoute("acceptance/tigris_acceptance.json", "tigris_acceptance", "validate_tigris_acceptance"),
