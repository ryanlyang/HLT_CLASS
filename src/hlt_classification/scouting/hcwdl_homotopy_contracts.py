...
COORDINATE_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_COORDINATE/v1"
NODE_SPEC_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_NODE_SPEC/v1"
GRAPH_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_GRAPH/v1"
RECIPE_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_RECIPE/v1"
ENDPOINT_LOCK_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_ENDPOINT_EQUALITY_LOCK/v1"
GRAPH_RECIPE_LOCK_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_GRAPH_RECIPE_LOCK/v1"
PILOT_SPEC_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_PILOT_SPEC/v1"
COMMAND_PLAN_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_COMMAND_PLAN/v1"
...
AGGREGATE_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_AGGREGATE/v1"
...
CAMPAIGN_COMPLETION_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_CAMPAIGN_COMPLETE/v1"
...
RECOVERY_SPEC_CONTRACT: Final = "HCWDL_STRUCTURAL_FEATURE_RECOVERY_SPEC/v1"
...
def coordinate_payload() -> dict[str, Any]:
    ...
    rows = []
    rows.extend(row(f"U{index * 10:03d}", index, 10, 0) for index in range(1, 11))
    rows.extend(row(f"D{100-index * 10}F", 1, 1, index) for index in range(1, 11))
    rows.extend(row(f"J{index * 5:03d}", index, 20, index) for index in range(1, 21))
...
def content_payload(contract: str, **fields: Any) -> dict[str, Any]:
    """Build a generic authenticated v1 payload without weakening validators."""
