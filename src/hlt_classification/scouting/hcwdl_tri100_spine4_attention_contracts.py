"""Versioned artifacts for the persistent-HLT attention-reoptimization spines."""
...
PREFIX: Final = "HCWDL_TRI100_FOUR_SPINE_FULLCARD_PERSISTENT_HLT_ATTENTION_REOPT"
...
PARAMETER_LOCK_CONTRACT: Final = f"{PREFIX}_PARAMETER_LOCK/v1"
...
CONTRACTS: Final = (
    GRAPH_CONTRACT, RECIPE_CONTRACT, SPEC_CONTRACT, PLAN_CONTRACT,
    PARAMETER_LOCK_CONTRACT, EXECUTION_ACCEPTANCE_CONTRACT,
    TRAINING_REPORT_CONTRACT, SELECTED_CHECKPOINT_CONTRACT,
    FINAL_CHECKPOINT_CONTRACT, STAGE_REPORT_CONTRACT, AGGREGATE_CONTRACT,
...
def artifact(payload: Mapping[str, Any], *, contract: str) -> dict[str, Any]:
    if contract not in CONTRACTS:
        raise ValueError("unknown attention four-spine contract")
