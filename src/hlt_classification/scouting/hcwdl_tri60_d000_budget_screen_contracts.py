"""Versioned artifacts for the TRI60 D000 optimization-budget screen."""
...
PREFIX: Final = "HCWDL_TRI60_D000_OPTIMIZATION_BUDGET_SCREEN"
...
def artifact(payload: Mapping[str, Any], *, contract: str) -> dict[str, Any]:
    if contract not in CONTRACTS:
        raise ValueError("unknown TRI60 D000 budget-screen contract")
