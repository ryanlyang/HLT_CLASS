...
BALANCED_WIRING_REPAIR_EVIDENCE_CONTRACT: Final = (
    "HCWDL_UNIFIED_BALANCED_FULL_BALANCED_WIRING_REPAIR_EVIDENCE/v1"
)
BALANCED_WIRING_RECOVERY_SPEC_CONTRACT: Final = (
