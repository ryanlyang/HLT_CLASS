"""Versioned artifacts for the standalone TRI60 M1 compression screen."""
...
PREFIX: Final = "HCWDL_TRI60_M1_COMPRESSION_SCREEN"
...
CONTRACTS: Final = (
    ...
    AGGREGATE_CONTRACT, CAMPAIGN_COMPLETE_CONTRACT, MONITOR_CONTRACT,
...
def artifact(payload: Mapping[str, Any], *, contract: str) -> dict[str, Any]:
    if contract not in CONTRACTS:
        raise ValueError("unknown TRI60 M1 screen contract")
