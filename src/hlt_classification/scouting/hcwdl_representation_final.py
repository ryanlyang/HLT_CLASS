...
PREDICTION_SPEC_CONTRACT: Final = "HCWDL_REPRESENTATION_FINAL_PREDICTION_SPEC/v2"
...
def build_finalist_lock(
    *,
    ...
    if {row["finalist_id"] for row in endpoint_rows} != set(REPRESENTATION_ENDPOINTS):
        raise ValueError("representation finalist registry must contain the four seed-1337 M1 endpoints")
