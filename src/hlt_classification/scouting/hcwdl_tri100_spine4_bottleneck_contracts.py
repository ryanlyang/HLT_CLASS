"""Versioned artifacts for persistent-HLT-support TRI100 four-spine control."""
...
PREFIX: Final = "HCWDL_TRI100_FOUR_SPINE_FULLCARD_PERSISTENT_HLT"
...
SUPPORT_AUDIT_CONTRACT: Final = f"{PREFIX}_SUPPORT_AUDIT/v2"
...
CONTRACTS: Final = (
    GRAPH_CONTRACT, RECIPE_CONTRACT, SOURCE_LOCK_CONTRACT, SUPPORT_AUDIT_CONTRACT,
