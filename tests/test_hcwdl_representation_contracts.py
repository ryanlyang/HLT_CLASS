...
EXPECTED_CONTRACTS = {
    ...
    "HCWDL_REPRESENTATION_RECIPE/v3",
    "HCWDL_REPRESENTATION_KERNEL_RESOURCES/v1",
    "HCWDL_REPRESENTATION_TAP/v1",
    "HCWDL_REPRESENTATION_SURFACE_PARITY/v2",
    "HCWDL_REPRESENTATION_TARGET_FORWARD_SPEC/v2",
    "HCWDL_REPRESENTATION_TARGET_EXECUTION_ATTESTATION/v2",
    "HCWDL_REPRESENTATION_TARGET_LOGICAL_BANK/v2",
    "HCWDL_REPRESENTATION_TARGET_CONSUMER_REGISTRY/v2",
    "HCWDL_REPRESENTATION_TARGET_BUILD_INTENT/v2",
    "HCWDL_REPRESENTATION_TARGET_GENERATION/v2",
    "HCWDL_REPRESENTATION_TARGET_SHARD/v2",
    "HCWDL_REPRESENTATION_TARGET_MANIFEST/v2",
    ...
    "HCWDL_REPRESENTATION_SCREEN_AGGREGATE/v2",
    ...
    "HCWDL_REPRESENTATION_CAMPAIGN_SPEC/v2",
    "HCWDL_REPRESENTATION_COMMAND_PLAN/v2",
