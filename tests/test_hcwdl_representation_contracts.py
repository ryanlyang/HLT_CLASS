...
EXPECTED_CONTRACTS = {
    ...
    "HCWDL_REPRESENTATION_DENSE_DESCENT_GRAPH/v1",
    "HCWDL_REPRESENTATION_RECIPE/v4",
    "HCWDL_REPRESENTATION_DENSE_TEACHER_IMPORT/v1",
    "HCWDL_REPRESENTATION_DENSE_TRAINING_AGGREGATE/v1",
    "HCWDL_REPRESENTATION_DENSE_TRAINING_DISPOSITION/v1",
    "HCWDL_REPRESENTATION_DENSE_SMOKE_ACCEPTANCE/v1",
    "HCWDL_REPRESENTATION_KERNEL_RESOURCES/v1",
    "HCWDL_REPRESENTATION_TAP/v1",
    "HCWDL_REPRESENTATION_SURFACE_PARITY/v2",
    "HCWDL_REPRESENTATION_TARGET_FORWARD_SPEC/v3",
    "HCWDL_REPRESENTATION_TARGET_EXECUTION_ATTESTATION/v3",
    "HCWDL_REPRESENTATION_TARGET_LOGICAL_BANK/v3",
    "HCWDL_REPRESENTATION_TARGET_CONSUMER_REGISTRY/v3",
    "HCWDL_REPRESENTATION_TARGET_BUILD_INTENT/v3",
    "HCWDL_REPRESENTATION_TARGET_GENERATION/v3",
    "HCWDL_REPRESENTATION_TARGET_SHARD/v3",
    "HCWDL_REPRESENTATION_TARGET_MANIFEST/v3",
    ...
    "HCWDL_REPRESENTATION_CONTROL_REGISTRY/v2",
    ...
    "HCWDL_REPRESENTATION_TRAINING_REPORT/v2",
    ...
    "HCWDL_REPRESENTATION_MODEL_EXTRACTION/v2",
    "HCWDL_REPRESENTATION_SCREEN_AGGREGATE/v3",
    "HCWDL_REPRESENTATION_CONFIRMATION_REGISTRY/v2",
    "HCWDL_REPRESENTATION_CONFIRMATION_AGGREGATE/v2",
    "HCWDL_REPRESENTATION_CONFIRMATION_RUN/v2",
    ...
    "HCWDL_REPRESENTATION_FINALIST_LOCK/v2",
    ...
    "HCWDL_REPRESENTATION_FINAL_EVALUATION/v2",
    "HCWDL_REPRESENTATION_PREDICTION_SHARD/v2",
    "HCWDL_REPRESENTATION_PREDICTION_MANIFEST/v2",
    "HCWDL_REPRESENTATION_METRIC_JOIN/v2",
    "HCWDL_REPRESENTATION_FINAL_AGGREGATE/v2",
    "HCWDL_REPRESENTATION_CAMPAIGN_SPEC/v3",
    "HCWDL_REPRESENTATION_COMMAND_PLAN/v3",
    "HCWDL_REPRESENTATION_RUNTIME_BINDING/v1",
    "HCWDL_REPRESENTATION_RUNTIME_PREREQUISITES/v2",
    "HCWDL_REPRESENTATION_RUNTIME_DRY_RUN_AUDIT/v1",
    "HCWDL_REPRESENTATION_WORKER_RUNTIME_MEASUREMENT/v1",
    "HCWDL_REPRESENTATION_EXECUTABLE_CANDIDATE_AUDIT/v2",
    ...
    "HCWDL_REPRESENTATION_DENSE_RESOURCE_PROFILE/v1",
    "HCWDL_REPRESENTATION_DENSE_COMPATIBLE_RESOURCE_PROFILE/v1",
    "HCWDL_REPRESENTATION_DENSE_RESOURCE_PROBE_PLAN/v1",
    "HCWDL_REPRESENTATION_DENSE_RESOURCE_PROBE_AUTHORIZATION/v1",
    "HCWDL_REPRESENTATION_DENSE_RESOURCE_PROBE_LEDGER/v1",
    ...
    "HCWDL_REPRESENTATION_SUBMISSION_AUTHORIZATION/v2",
...
def test_contract_registry_is_exactly_the_plan_frozen_section_21_registry() -> None:
    ...
    assert "HCWDL_REPRESENTATION_USR1_EXACT_RESUME_PROOF/v1" not in CONTRACTS
    assert "HCWDL_REPRESENTATION_VALIDATION_PROXY_PROOF/v1" not in CONTRACTS
    assert "HCWDL_REPRESENTATION_TIGRIS_EVIDENCE_BUNDLE/v1" not in CONTRACTS
    assert "HCWDL_REPRESENTATION_TIGRIS_ACCEPTANCE/v1" not in CONTRACTS


def test_nonfinal_acceptance_contract_identities_are_exact() -> None:
    assert ACCEPTANCE_REAL_BATCH_FULL_LOSS_CONTRACT.endswith(
        "ACCEPTANCE_REAL_BATCH_FULL_LOSS/v1"
    )
    assert NONFINAL_ACCEPTANCE_ACTION_ASSEMBLY_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_ACTION_ASSEMBLY/v1"
    )
    assert NONFINAL_ACCEPTANCE_ACTION_INPUTS_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_ACTION_INPUTS/v1"
    )
    assert NONFINAL_ACCEPTANCE_ACTION_RESULT_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_ACTION_RESULT/v1"
    )
    assert NONFINAL_ACCEPTANCE_AUTHORITY_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_AUTHORITY/v1"
    )
    assert NONFINAL_ACCEPTANCE_EXECUTION_RECEIPT_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_EXECUTION_RECEIPT/v1"
    )
    assert TWO_UPDATE_ACCEPTANCE_PROOF_CONTRACT.endswith(
        "TWO_UPDATE_ACCEPTANCE_PROOF/v1"
    )
    assert USR1_DELIVERY_RECEIPT_CONTRACT.endswith("USR1_DELIVERY_RECEIPT/v1")
    assert USR1_EXACT_RESUME_PROOF_CONTRACT.endswith("USR1_EXACT_RESUME_PROOF/v2")
    assert VALIDATION_PROXY_BRANCH_ACCESS_CONTRACT.endswith(
        "VALIDATION_PROXY_BRANCH_ACCESS/v1"
    )
    assert VALIDATION_PROXY_PROOF_CONTRACT.endswith("VALIDATION_PROXY_PROOF/v2")
    assert NONFINAL_ACCEPTANCE_SCHEDULER_EVIDENCE_CONTRACT.endswith(
        "NONFINAL_ACCEPTANCE_SCHEDULER_EVIDENCE/v1"
    )
    assert contract_schema_version(USR1_EXACT_RESUME_PROOF_CONTRACT) == 1
    assert contract_schema_version(VALIDATION_PROXY_PROOF_CONTRACT) == 1
    assert contract_schema_version(TIGRIS_EVIDENCE_BUNDLE_CONTRACT) == 1
...
def test_durable_module_publications_use_central_contract_identities() -> None:
    ...
    from hlt_classification.scouting.hcwdl_representation_nonfinal_acceptance import (
        NONFINAL_ACCEPTANCE_AUTHORITY_CONTRACT as action_authority,
        TWO_UPDATE_ACCEPTANCE_PROOF_CONTRACT as action_two_update,
        USR1_DELIVERY_RECEIPT_CONTRACT as action_usr1_receipt,
        USR1_EXACT_RESUME_PROOF_CONTRACT as action_usr1_proof,
    )
    ...
    from hlt_classification.scouting.hcwdl_representation_validation_proxy import (
        VALIDATION_PROXY_BRANCH_ACCESS_CONTRACT as proxy_branch_access,
        VALIDATION_PROXY_PROOF_CONTRACT as proxy_proof,
    )
    ...
    assert action_authority == NONFINAL_ACCEPTANCE_AUTHORITY_CONTRACT
    assert action_two_update == TWO_UPDATE_ACCEPTANCE_PROOF_CONTRACT
    assert action_usr1_receipt == USR1_DELIVERY_RECEIPT_CONTRACT
    assert action_usr1_proof == USR1_EXACT_RESUME_PROOF_CONTRACT
    assert proxy_branch_access == VALIDATION_PROXY_BRANCH_ACCESS_CONTRACT
    assert proxy_proof == VALIDATION_PROXY_PROOF_CONTRACT
