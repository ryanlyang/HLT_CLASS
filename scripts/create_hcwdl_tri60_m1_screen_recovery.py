#!/usr/bin/env python3
"""Create restart-from-zero recovery for the TRI60 M1 screen."""
...
from hlt_classification.scouting.hcwdl_tri60_m1_screen_recovery import create_recovery  # noqa: E402
