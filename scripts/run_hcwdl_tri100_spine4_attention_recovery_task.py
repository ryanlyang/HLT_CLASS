#!/usr/bin/env python3
"""Run one restart-zero attention-spine recovery task."""
...
from hlt_classification.scouting.hcwdl_tri100_spine4_attention_recovery import clean_incomplete_task_outputs,validate_recovery  # noqa:E402
from hlt_classification.scouting.hcwdl_tri100_spine4_attention_workflow import AttentionSpine4Workflow,task_outputs  # noqa:E402
def main()->int:
