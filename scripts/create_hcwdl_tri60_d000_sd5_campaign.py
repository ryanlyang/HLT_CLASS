#!/usr/bin/env python3
"""Create the full-data TRI60 matched-seed D000 ablation."""
...
def main() -> int:
    ...
    parser.add_argument("--ce5-campaign-spec", type=Path, required=True)
    ...
    value = create_campaign(
        ...
        ce5_campaign_spec=args.ce5_campaign_spec,
