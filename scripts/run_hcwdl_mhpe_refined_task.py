#!/usr/bin/env python3
"""Run one source-pinned refined MHPE continuation task."""
...
from hlt_classification.scouting.hcwdl_mhpe_refined import AUGMENTED_ENSEMBLES  # noqa:E402
