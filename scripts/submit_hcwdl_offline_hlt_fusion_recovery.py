#!/usr/bin/env python3
"""Dry-run or submit a fusion restart-zero recovery DAG."""
...
from hlt_classification.scouting.hcwdl_offline_hlt_fusion_campaign import RECOVERY_SUBMISSION_PHRASE  # noqa:E402
from hlt_classification.scouting.hcwdl_offline_hlt_fusion_contracts import PLAN_CONTRACT,validate_artifact  # noqa:E402
from hlt_classification.scouting.hcwdl_offline_hlt_fusion_recovery import validate_recovery  # noqa:E402
def main()->int:
 ...
 if a.execute:
  if a.authorization_phrase!=RECOVERY_SUBMISSION_PHRASE:raise PermissionError("fusion recovery submission phrase differs")
  if ROOT.resolve()!=Path(recovery["project_dir"]).resolve():raise PermissionError("fusion recovery submitter is outside bound worktree")
