#!/usr/bin/env python3
"""Run one restart-from-zero TRI60 M1 screen recovery task."""
...
from hlt_classification.scouting.hcwdl_tri60_m1_screen_recovery import clean_incomplete_task_outputs, validate_recovery  # noqa: E402
from hlt_classification.scouting.hcwdl_tri60_m1_screen_workflow import M1ScreenWorkflow, task_outputs  # noqa: E402
...
def main() -> int:
    ...
    write_immutable_json(
        task_attestation_path(recovery["recovery_root"], args.task, None), attestation,
    )
    print(json.dumps({"task": args.task, "content_hash": result.get("content_hash")}, sort_keys=True))
    return 0
