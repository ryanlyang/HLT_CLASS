#!/usr/bin/env python3
"""Authenticate and summarize one HCWDL-UB-FULLCOARSE3 ledger."""
...
def main()->int:
 ...
 if ledger["campaign_spec_sha256"]!=spec["content_hash"]:raise ValueError("coarse monitor ledger/spec differs")
