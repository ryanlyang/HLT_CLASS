#!/usr/bin/env python3
"""Run one exact TRI60 matched-seed D000 ablation task."""
...
from hlt_classification.scouting.hcwdl_tri60_d000_sd5_workflow import (  # noqa: E402
    D000SD5Workflow, task_outputs,
)
...
def main() -> int:
    ...
    result = D000SD5Workflow(spec).run(args.task, device=args.device)
