#!/usr/bin/env python3
"""Create the three isolated HCWDL-UB-FULL3 arm specifications."""
from __future__ import annotations
import argparse, json
from pathlib import Path
import sys
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT/"src"))
from hlt_classification.scouting.hcwdl_unified_balanced_full_campaign import create_arm_specs  # noqa:E402
def main()->int:
