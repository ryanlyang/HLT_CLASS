#!/usr/bin/env python3
"""Print or execute exact-ID cancellation for one HCWDL-UB-FULL3 ledger."""
...
PHRASE="CANCEL HCWDL UB FULL3 EXACT IDS"
def main()->int:
 ...
 if a.execute:
  if a.authorization_phrase!=PHRASE:raise PermissionError("HCWDL-UB-FULL3 cancellation phrase differs")
