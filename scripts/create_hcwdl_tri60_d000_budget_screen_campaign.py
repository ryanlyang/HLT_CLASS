#!/usr/bin/env python3
"""Create the standalone full-data TRI60 D000 optimization-budget screen."""
...
from hlt_classification.scouting.hcwdl_tri60_d000_budget_screen_campaign import create_campaign  # noqa: E402
