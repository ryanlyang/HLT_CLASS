#!/usr/bin/env python3
"""Create the three isolated full-data HCWDL-UB-FULLCOARSE3 arms."""
from __future__ import annotations
import argparse,json
from pathlib import Path
import sys
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT/"src"))
from hlt_classification.scouting.hcwdl_unified_balanced_coarse_campaign import create_arm_specs  # noqa:E402
def main()->int:
 ...
 print(json.dumps({arm:{"root":spec["campaign_root"],"spec_sha256":spec["content_hash"],"fits":spec["node_count"]} for arm,spec in specs.items()},indent=2,sort_keys=True));return 0
