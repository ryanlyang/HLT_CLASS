#!/usr/bin/env python3
"""Dry-run or submit an exact MT20 recovery DAG."""
...
from hlt_classification.scouting.hcwdl_tri100_spine4_mt20_campaign import RECOVERY_SUBMISSION_PHRASE  # noqa:E402
from hlt_classification.scouting.hcwdl_tri100_spine4_mt20_contracts import PLAN_CONTRACT,validate_artifact  # noqa:E402
from hlt_classification.scouting.hcwdl_tri100_spine4_mt20_recovery import validate_recovery  # noqa:E402
def main()->int:
 ...
 if a.execute:
  if a.authorization_phrase!=RECOVERY_SUBMISSION_PHRASE:raise PermissionError("MT20 recovery phrase differs")
  if ROOT.resolve()!=Path(recovery["project_dir"]).resolve():raise PermissionError("MT20 recovery submitter is outside bound worktree")
