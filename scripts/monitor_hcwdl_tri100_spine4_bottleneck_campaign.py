#!/usr/bin/env python3
"""Write an exact-ID monitor for the bottleneck campaign ledger."""
...
from hlt_classification.scouting.hcwdl_tri100_spine4_bottleneck_campaign import validate_campaign  # noqa:E402
from hlt_classification.scouting.hcwdl_tri100_spine4_bottleneck_recovery import build_monitor  # noqa:E402
def main()->int:
