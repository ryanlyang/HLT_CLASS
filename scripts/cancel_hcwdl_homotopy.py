#!/usr/bin/env python3
"""Print or execute exact-ID cancellation for one HCWDL-UJ ledger."""
...
PHRASE="CANCEL HCWDL UJ EXACT IDS"
def main()->int:
    ...
    if a.execute:
        if a.authorization_phrase!=PHRASE: raise PermissionError("HCWDL-UJ cancellation phrase differs")
