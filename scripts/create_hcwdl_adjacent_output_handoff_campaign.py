#!/usr/bin/env python3
"""Create the exact adjacent-view output-handoff campaign."""
from __future__ import annotations
import argparse
from pathlib import Path
import sys
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT/"src"))
from hlt_classification.scouting.hcwdl_adjacent_output_handoff_campaign import create_campaign  # noqa:E402
def main()->int:
