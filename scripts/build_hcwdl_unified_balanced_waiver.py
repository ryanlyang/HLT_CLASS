...
def main()->int:
    ...
    p.add_argument("--source-commit",required=True); p.add_argument("--parent-preparation-lock",type=Path,required=True); p.add_argument("--parent-homotopy-spec",type=Path,required=True)
    ...
    parent=load_json(a.parent_preparation_lock); smoke=load_json(a.prior_smoke_completion); parent_spec=load_json(a.parent_homotopy_spec)
