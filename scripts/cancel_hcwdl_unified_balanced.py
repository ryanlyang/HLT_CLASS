#!/usr/bin/env python3
"""Print or execute exact-ID cancellation for one HCWDL-UB ledger."""
...
PHRASE="CANCEL HCWDL UB EXACT IDS"
def main()->int:
    ...
    if a.execute:
        if a.authorization_phrase!=PHRASE: raise PermissionError("HCWDL-UB cancellation phrase differs")
