#!/usr/bin/env python3
"""Write an exact-ID monitor for one TRI60 dense-extension ledger."""
...
from hlt_classification.scouting.hcwdl_mhpe_tri60_dense_campaign import validate_campaign  # noqa:E402
from hlt_classification.scouting.hcwdl_mhpe_tri60_dense_recovery import build_monitor  # noqa:E402
def main()->int:
