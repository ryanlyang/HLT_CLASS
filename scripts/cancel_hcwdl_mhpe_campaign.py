#!/usr/bin/env python3
"""Print or execute exact-ID cancellation for one HCWDL-MHPE ledger."""
...
PHRASE="CANCEL HCWDL MHPE EXACT IDS"
def main()->int:
 ...
 if a.execute:
  if a.authorization_phrase!=PHRASE:raise PermissionError("MHPE cancellation phrase differs")
