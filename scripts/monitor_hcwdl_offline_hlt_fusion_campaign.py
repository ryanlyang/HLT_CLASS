#!/usr/bin/env python3
"""Write an exact-job-ID monitor for fusion withdrawal."""
...
from hlt_classification.scouting.hcwdl_offline_hlt_fusion_campaign import validate_campaign  # noqa:E402
from hlt_classification.scouting.hcwdl_offline_hlt_fusion_recovery import build_monitor  # noqa:E402
def main()->int:
