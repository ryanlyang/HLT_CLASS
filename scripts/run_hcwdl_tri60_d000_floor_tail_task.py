#!/usr/bin/env python3
"""Run one matched D000 floor-tail confirmation task."""
...
from hlt_classification.scouting.hcwdl_tri60_d000_floor_tail_workflow import FloorTailWorkflow, task_outputs  # noqa: E402
...
def main() -> int:
    ...
    result = FloorTailWorkflow(spec).run(args.task, device=args.device)
