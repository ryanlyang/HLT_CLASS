#!/usr/bin/env python3
"""Create the immutable full-data TRI100 four-spine campaign."""
from __future__ import annotations
import argparse
from pathlib import Path
import sys
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT/"src"))
from hlt_classification.scouting.hcwdl_tri100_spine4_campaign import create_campaign  # noqa:E402
def main()->int:
