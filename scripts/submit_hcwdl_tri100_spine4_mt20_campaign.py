#!/usr/bin/env python3
"""Dry-run or submit the isolated persistent-HLT MT20 four-spine DAG."""
...
from hlt_classification.scouting.hcwdl_tri100_spine4_mt20_campaign import SUBMISSION_PHRASE,validate_campaign  # noqa:E402
...
def main()->int:
 ...
 if a.execute:
  if a.authorization_phrase!=SUBMISSION_PHRASE:raise PermissionError("MT20 submission phrase differs")
  if ROOT.resolve()!=Path(spec["project_dir"]).resolve():raise PermissionError("MT20 submitter is outside bound worktree")
