#!/usr/bin/env python3
"""Run one restart-zero output-handoff recovery task."""
...
from hlt_classification.scouting.hcwdl_adjacent_output_handoff_recovery import clean_incomplete_task_outputs,validate_recovery  # noqa:E402
from hlt_classification.scouting.hcwdl_adjacent_output_handoff_workflow import OutputHandoffWorkflow,task_outputs  # noqa:E402
def main()->int:
