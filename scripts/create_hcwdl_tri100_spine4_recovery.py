#!/usr/bin/env python3
"""Create restart-from-zero recovery for a terminal TRI100 spine4 ledger."""
from __future__ import annotations
import argparse
from pathlib import Path
import sys
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT/"src"))
from hlt_classification.scouting.hcwdl_tri100_spine4_recovery import create_recovery  # noqa:E402
def main()->int:
