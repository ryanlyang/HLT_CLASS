...
- real-Weaver FP32 logits, finite training-required gradients, masks, and
  state-dictionary parity, plus exact auxiliary Lorentz-input derivative
  finite/NaN/+Inf/-Inf topology and finite-entry values;
