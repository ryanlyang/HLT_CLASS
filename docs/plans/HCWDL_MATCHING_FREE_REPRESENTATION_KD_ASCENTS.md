...
- dense resource profile, resource-probe plan/authorization/ledger, bounded
  collector-recovery authorization/ledger, serialized storage template, and
  dense storage estimate `/v1`;
